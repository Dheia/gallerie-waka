    ...
    <form @submit.prevent="submit">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="flex mb-4 space-x-2">
                ...
                <div class="w-1/2">
                    <InputLabel for="slug" value="Slug/Code : " />
                    <TextInput
                        id="slug"
                        v-model="form.slug"
                        type="text"
                        ...
                        autofocus
                        autocomplete="titre"
                        placeholder="Entrez un code / slug de page"
                    />
                    <InputError
                        class="mt-2"
            ...
            <div>
                ...
                <div class="mb-4" v-if="staticOptions.image">
...
export default {
    props: ["form", "staticOptions", "isOpen", "isEdit", "isWorking"],
    components: {
        InputError,
        InputLabel,
        TextInput,
