                    ...
                    <div class="w-full max-w-lg lg:max-w-xs">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                name="search"
                                class="block w-full rounded-md border border-transparent bg-mydark py-2 pl-10 pr-3 leading-5 text-gray-300 placeholder-gray-400 focus:border-white focus:bg-white focus:text-gray-900 focus:outline-none focus:ring-white sm:text-sm"
                    ...
                    <div class="hidden lg:ml-6 lg:block">
                        <div class="flex space-x-4 font-heading">
                            ...
                            <button
                                ...
                                class="rounded-md px-3 py-2 font-medium text-gray-300 hover:bg-gray-700 hover:text-white"></button>
                            <Mail />
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:ml-4 lg:block">
                    <div class="flex items-center">
                        <DisclosureButton
                            ...
                            <SunIcon v-if="isDark" class="h-6 w-6" aria-hidden="true" /><MoonIcon v-else class="h-6 w-6" aria-hidden="true" />
                        </DisclosureButton>
                        ...
                        <Menu as="div" class="relative ml-4 flex-shrink-0">
                            <div>
                                <MenuButton
                                    class="flex rounded-full bg-gray-800 text-sm p-1 text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
        ...
        <DisclosurePanel class="lg:hidden">
            <div class="space-y-1 px-2 pt-2 pb-3 font-heading">
                ...
                <DisclosureButton
                    ...
                    @click="$emit('toogleBio')"
                    as="button"
                    class="w-full text-left block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white"></DisclosureButton>
                ...
                <DisclosureButton
                    @click="$emit('toogleBio')"
                    href="'pages/mentions"
                    class="w-full text-left block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Mentions légales</DisclosureButton>
            </div>
...
import {Bars3Icon, BellIcon, XMarkIcon, LockClosedIcon, LockOpenIcon, MoonIcon, SunIcon} from "@heroicons/vue/24/outline";
