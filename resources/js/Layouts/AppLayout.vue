    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('tableaux.index')">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('tableautags.index')" :active="route().current('tags.index')"> Tags </NavLink>
                                <NavLink :href="route('pages.index')" :active="route().current('pages.index')"> Pages </NavLink>
                                <NavLink :href="route('welcome')"> Voir le site </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{block: showingNavigationDropdown, hidden: !showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')"> Dashboard XX </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('tableaux.index')" :active="route().current('tableaux.index')">
                                {{ $page.component }}
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('tableautags.index')" :active="route().current('tags.index')"> Tags </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('pages.index')" :active="route().current('pages.index')"> Pages </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('welcome')"> Voir le site </ResponsiveNavLink>
            ...
            <header v-if="$slots.header" class="bg-white shadow">
                <div class="mx-auto py-2 px-4 sm:px-6 lg:px-8 min-h-[60px]">
                    <slot name="header" />
                </div>
            </header>

            <transition :name="animate" appear>
                <main :key="$page.component" class="mx-auto relative">
                    <slot />
                </main>
            </transition>
        </div>
